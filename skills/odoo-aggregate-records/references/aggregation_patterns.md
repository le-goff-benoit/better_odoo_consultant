...
- Besoin d'enregistrements individuels (pas d'agrégat) → `odoo_query_records`
- Juste un nombre total → `odoo_count_records` (plus simple, plus rapide)
- Champ inconnu → `odoo_inspect_fields` d'abord
