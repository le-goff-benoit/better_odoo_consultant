# Usage canonique — source_show_commit
...
- Pour un commit énorme (refactor cross-modules), `max_lines=2000` peut encore borner — relancer avec `max_lines=10000` ou lire les fichiers listés avec `source_read_odoo_file` / `repo_read_file`.
