# Usage canonique — odoo_inspect_modules
...
> | ... (9 autres) |
>
> Les modules `acme_*` ressemblent à des développements client. Pour un audit du code, je peux les ouvrir un par un avec `repo_read_file` ou en faire l'inventaire des manifests via `repo_list_modules`.
