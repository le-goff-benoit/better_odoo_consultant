...
auto_keywords:
  weak: [architecture, architecte, scalabilité, scalability, urbanisation, dépendance, dependance, "stratégie de migration", "strategie de migration", "choix technique", adr, risque, risques, "multi-société", "multi-societe", "multi-company", pattern, patterns, volumétrie, "haute disponibilité", pra, rto, rpo, indexation, cluster, "load balanc", "community vs enterprise", "community ou enterprise", "oca vs", roadmap, "feuille de route", gouvernance, hébergement, hébergeur, héberger, infrastructure, "on-premise", "on premise", déploiement, deploiement, saas, cloud, dimensionnement, "multi-pays", multicompany, "multi pays", oca, "développement interne", "developpement interne", trajectoire, "conçois", "concevoir", "modèle de sécurité", "modele de securite", "plan de cutover", rollout, consolidation, "stratégie de tests", "strategie de tests", "groupe avec filiales", "frontière entre studio et module custom", "frontiere entre studio et module custom", "réduire la dette technique", "reduire la dette technique", "contrat api", "stack reporting", "stratégie edi", "strategie edi", blueprint, ownership, référentiels, referentiels, backup, restore, pra, "orchestrer ba", "coûts provider", "couts provider", archivage, "registre des risques", "comparer odoo.sh", "hébergement managé", "hebergement manage", "avant upgrade", "clients publics", "qr-bill", upgrade, "graphe de dépendances", "graphe de dependances", "diagramme du flux", "stratégie performance", "strategie performance", "blueprint odoo", intercos, "reporting consolidé", "reporting consolide"]
  strong: [architecture, architecte, adr, "rédige un adr", "redige un adr", "haute disponibilité", "multi-société", "multi-company", "stratégie de migration", "community vs enterprise", "oca vs", scalabilité, gouvernance, "community ou enterprise", hébergeur, roadmap, trajectoire, "choix technique", "multi-pays", "modèle de sécurité", "modele de securite", "plan de cutover", rollout, "stratégie de tests", "strategie de tests", consolidation, "groupe avec filiales", "frontière entre studio", "frontiere entre studio", "frontière studio/custom", "frontiere studio/custom", "dette technique", "contrat api", "stack reporting", "stratégie edi", "strategie edi", blueprint, ownership, backup, restore, pra, "orchestrer ba", "coûts provider", "couts provider", archivage, "registre des risques", "comparer odoo.sh", "hébergement managé", "hebergement manage", "avant upgrade", "clients publics", "qr-bill", "feuille de route upgrade", "graphe de dépendances", "graphe de dependances", "dessine un diagramme", "stratégie performance", "strategie performance", "architecture performance", "blueprint odoo", "reporting consolidé", "reporting consolide"]
