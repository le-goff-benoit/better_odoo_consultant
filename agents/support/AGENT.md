...
auto_keywords:
  weak: [incident, bug, crash, plante, crashe, workaround, contournement, ticket, sla, reproduire, panne, "hors service", urgence, urgent, critique, p1, p2, lenteur, freeze, timeout, "ne fonctionne pas", "n'arrive pas", "ne marche pas", "ne charge pas", résoudre, fix, corriger, erreur, planté, plantée, bloqué, bloque, bloquée, connexion, impossible]
