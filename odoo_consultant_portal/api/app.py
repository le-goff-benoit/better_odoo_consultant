...
from .routes import sources, profiles, projects, queries, history, ai, context, creator, settings as settings_routes
...
app = FastAPI(title="Odoo Consultant Portal", version="0.1.0", lifespan=lifespan)
