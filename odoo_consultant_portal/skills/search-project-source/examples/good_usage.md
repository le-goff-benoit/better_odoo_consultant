# Usage canonique — search_project_source
...
**Pièges à éviter** :
- `search_project_source` ne cherche QUE dans le repo cloné du client — pas dans le code Odoo standard. Pour ça, utiliser `search_odoo_source`.
