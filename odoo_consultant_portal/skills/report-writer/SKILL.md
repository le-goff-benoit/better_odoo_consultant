...
description: "Impose un format standardisé aux rapports, emails, plans de migration et cahiers des charges produits par l'assistant — fini les structures improvisées."
description_en: "Enforces a standardized format for reports, emails, migration plans and functional specs the assistant produces — no more improvised structure."
requirement: Aucun
requirement_en: None
...
2. Charge le template correspondant (`load_skill_reference("report_writer", "templates/<name>.md")` si pas déjà injecté).
