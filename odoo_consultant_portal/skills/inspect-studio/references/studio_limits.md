...
> Cette référence n'est *pas* chargée en permanence. Le LLM doit l'appeler via `load_skill_reference("inspect_studio", "studio_limits.md")` quand l'utilisateur évoque un blocage, une migration Studio, ou un comportement Studio surprenant.
