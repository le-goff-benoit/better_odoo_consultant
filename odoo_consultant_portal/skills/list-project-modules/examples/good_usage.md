# Usage canonique — list_project_modules
...
- Le module retourne ses dépendances **déclarées**, pas les dépendances transitives. Pour l'arbre complet, croiser avec `inspect_installed_modules` côté instance.
