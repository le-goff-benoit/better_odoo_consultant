...
- **TVA** : le taux extrait du PDF (20%) doit correspondre à une `account.tax` Odoo. Faire `query_odoo({"model":"account.tax","domain":[["amount","=",20],["type_tax_use","=","purchase"]]})` si doute.
