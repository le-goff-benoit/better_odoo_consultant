  ...
  },
  {
    ...
    models: [
      { id: 'gpt-4.1', label: 'GPT-4.1', recommended: true,
        desc: 'Dernière génération GPT — meilleur suivi des instructions, polyvalent et très efficace pour le code',
        tags: ['usage quotidien', 'polyvalent', 'code'] },
      { id: 'gpt-4.1-mini', label: 'GPT-4.1 mini',
        desc: 'Version légère de GPT-4.1 — rapide et économique, remplace avantageusement GPT-4o mini',
        tags: ['rapide', 'économique', 'volume'] },
      { id: 'gpt-4.1-nano', label: 'GPT-4.1 nano',
        desc: 'Version ultra-légère de GPT-4.1 — la plus rapide et économique de la gamme OpenAI',
        tags: ['rapide', 'économique'] },
      { id: 'gpt-4o', label: 'GPT-4o',
        desc: 'Modèle phare multimodal d\'OpenAI — toujours très performant pour les tâches générales',
        tags: ['polyvalent', 'multimodal'] },
      { id: 'gpt-4o-mini', label: 'GPT-4o mini',
        desc: 'Version légère de GPT-4o — économique pour les tâches simples',
        tags: ['rapide', 'économique'] },
      { id: 'o4-mini', label: 'o4 mini',
        desc: 'Modèle de raisonnement compact d\'OpenAI — très performant sur code et maths, rapport qualité/prix optimal',
        tags: ['raisonnement', 'code', 'économique'] },
      { id: 'o3', label: 'o3',
        desc: 'Meilleur modèle de raisonnement OpenAI — analyse approfondie, problèmes complexes et multi-étapes',
      ...
      { id: 'o1-mini', label: 'o1 mini',
        desc: 'Modèle de raisonnement de première génération — analyse étape par étape',
        tags: ['raisonnement'] },
    ],
  },
  {
