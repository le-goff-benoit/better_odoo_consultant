  ...
  },
  {
    ...
    models: [
      ...
      { id: 'gpt-5.5', label: 'GPT-5.5', recommended: true,
        desc: 'Modèle phare OpenAI — nouvelle classe d\'intelligence, code et raisonnement complexe ($5/MTok, contexte 1M)',
        tags: ['puissant', 'raisonnement', 'code'] },
      { id: 'gpt-5.5-pro', label: 'GPT-5.5 Pro',
        desc: 'GPT-5.5 Pro — version haute performance pour les tâches les plus exigeantes ($30/MTok)',
        tags: ['puissant', 'expert'] },
      // ── Gamme GPT-5.4 ──
      { id: 'gpt-5.4', label: 'GPT-5.4',
        desc: 'GPT-5.4 — très bon pour le code et les agents, excellent rapport qualité/prix ($2.50/MTok, contexte 1M)',
        tags: ['polyvalent', 'code', 'agents'] },
      { id: 'gpt-5.4-pro', label: 'GPT-5.4 Pro',
        desc: 'GPT-5.4 Pro — version haute performance de GPT-5.4 ($30/MTok)',
        tags: ['puissant', 'agents'] },
      { id: 'gpt-5.4-mini', label: 'GPT-5.4 mini',
        desc: 'GPT-5.4 mini — rapide et économique, idéal pour les sous-agents et le computer use ($0.75/MTok)',
        tags: ['rapide', 'économique', 'agents'] },
      { id: 'gpt-5.4-nano', label: 'GPT-5.4 nano',
        desc: 'GPT-5.4 nano — ultra-léger, faible latence, le moins cher de la gamme ($0.20/MTok)',
        tags: ['rapide', 'économique', 'volume'] },
      // ── Codex ──
      { id: 'gpt-5.3-codex', label: 'GPT-5.3 Codex',
        desc: 'GPT-5.3 Codex — spécialisé code, compréhension et génération avancée ($1.75/MTok)',
      ...
      { id: 'gpt-4.1-mini', label: 'GPT-4.1 mini',
        desc: 'GPT-4.1 mini — version légère de GPT-4.1, rapide et économique',
        tags: ['rapide', 'économique'] },
      { id: 'gpt-4o', label: 'GPT-4o',
        desc: 'GPT-4o — modèle multimodal de génération précédente, toujours très performant',
        tags: ['multimodal', 'polyvalent'] },
      // ── O-series (raisonnement) ──
      { id: 'o4-mini', label: 'o4 mini',
        desc: 'o4 mini — raisonnement compact et économique, excellent sur le code et les maths',
        tags: ['raisonnement', 'code', 'économique'] },
      { id: 'o3', label: 'o3',
        desc: 'o3 — meilleur modèle de raisonnement OpenAI, analyse approfondie et problèmes multi-étapes',
        tags: ['raisonnement', 'puissant', 'analyse'] },
      { id: 'o3-mini', label: 'o3 mini',
        desc: 'o3 mini — raisonnement o3 en version économique, analytique et efficace',
